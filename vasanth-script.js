...
const Backgrounds = {
    ...
    4: "url('https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?auto=format&fit=crop&q=80&w=1920')"
};
...
let charts = {}; // Store chart instances to destroy them before rerendering
...
function showResults() {
    ...
    const finalAnnual = (finalDaily * 365) / 1000; // Convert kg/day to tonnes/year
...
function renderResultCharts() {
    ...
    charts.bar = new Chart(ctxBar, {
        ...
        data: {
            ...
            datasets: [{
                label: 'kg CO2e',
                data: [finalDaily, 5.75, 13.42], // 2.1t/365 and 4.9t/365
